...
int main()
{
  ...
  string instructions = "Press ENTER if you want to just use the default file names, or enter your custom file names";
  ...
  if (continueYN.length() == 0)
  {
    ...
    //Output emails to the file output and console
    cout << endl;
    ...
    {
      cout << "Number of valid email addresses is " << countEmails << ". These emails have been copied to " << oFileName <<endl;
    }
  } //if
